                    ...
                    @foreach($posts as $post)
                        <div class="post-content">
                            <div class="">
                                ...
                                In <strong><a class="text-body" href="{{ route('courses.show', $post->classroom->course->id)}}">{{ $post->classroom->course->code}}. {{ strtoupper($course->name)}}</a></strong><br>
                            </div>
                            <div>
                           ...
                           <div class="row">
                                <div class="col-md-4">
                                <img src="https://img.icons8.com/fluent-systems-filled/24/000000/facebook-like.png"/>
                                </div>
                                <div class="col-md-4">
